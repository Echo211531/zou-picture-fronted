...
export async function createPictureOutPaintingTaskUsingPost(
  ...
  return request<API.BaseResponseVoid_>('/api/picture/out_painting/create_task', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** uploadUserPicture POST /api/picture/uploadUserPicture */
export async function uploadUserPictureUsingPost(
  body: {},
  file?: File,
  options?: { [key: string]: any }
) {
  ...
  return request<API.BaseResponseUploadUserPictureResult_>('/api/picture/uploadUserPicture', {
    method: 'POST',
    data: formData,
    requestType: 'form',
    ...(options || {}),
